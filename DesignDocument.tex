...
\subsection{Levels/Objects} %level
	...
	{\bf Star Field and Background:} The background will be a tile that can be replicated across the screen to create a smooth, endless field of stars. The star field layered on top of the background image will emit a particle effect that will move across the screen, adding to the feel of being in space.

	{\bf Asteroids:}  Asteroids will be obstacles that will fly across the screen, dealing damage to anything they collide with. This will force players to be more aware of their surroundings. These obstacles have no set objective and can collide with each other as well as enemy's ships. (Add how they are spawned)
...
We are currently at a place in the project where many of the functional goals have been accomplished. We intended to have five different pick-ups, a loss condition, a boss with a corresponding win condition, and a level. We have finished all of these goals and created a playable and winnable game.
